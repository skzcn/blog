---
name: ui-ux-pro-max 专业 UI/UX 智能
description: 顶尖 UI/UX 设计智能指南。集成了 50+ 设计风格、97 套色板、57 组字体配对及 99 条 UX 准则。专注于设计系统生成、无障碍性（A11y）硬性约束、交互性能优化、光影/对比度深层控制及跨平台响应式标准。
---
...
- Create `design-system/MASTER.md` — Global Source of Truth with all design rules
- Create `design-system/pages/` — Folder for page-specific overrides
